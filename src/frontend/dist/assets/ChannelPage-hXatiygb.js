import { s as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, m as useParams, n as useQueryClient, g as getTenantId, d as useNavigate, h as useQuery, i as Link, X, b as MessageSquare, F as FileText } from "./index-BZqaRhAX.js";
...
import { P as Pin } from "./pin-0q9kQ_6q.js";
...
function MessageBubble({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `group flex items-start gap-3 px-4 py-2 rounded-xl transition-colors ${isMention ? "border-l-2 border-amber-500 bg-amber-500/5 hover:bg-amber-500/8" : "hover:bg-muted/30"}`,
...
function ChannelPage() {
  ...
  const myUnreadEntry = (_b = channel == null ? void 0 : channel.unreadCounts) == null ? void 0 : _b.find(
