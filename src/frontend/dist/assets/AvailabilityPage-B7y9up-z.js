import { d as useNavigate, m as useParams, g as getTenantId, r as reactExports, j as jsxRuntimeExports, B as Button, x as cn } from "./index-BZqaRhAX.js";
...
function AvailabilityPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background animate-fade-in-up", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-6 py-8 space-y-6", children: [
      ...
      slots.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      !isPending && slots.length === 0 && memberList.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No availability data yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: 'Click "Check Availability" to see the grid.' })
          ]
        }
      ),
      !isPending && slots.length === 0 && memberList.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
