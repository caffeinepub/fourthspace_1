...
import { t as createLucideIcon, m as useParams, aq as useInternetIdentity, g as getTenantId, n as useQueryClient, d as useNavigate, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, P as Plus, ab as __vitePreload, X, i as Link, ar as Variant_away_offline_online } from "./index-DemOGW1B.js";
...
function ChatPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in-up p-4 sm:p-6 max-w-3xl mx-auto space-y-4 sm:space-y-5 pb-20 md:pb-6", children: [
    ...
    members && members.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dm-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-muted-foreground", children: members.length - 1 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: members.map((member) => {
