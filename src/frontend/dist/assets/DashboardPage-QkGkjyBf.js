import { s as createLucideIcon, r as reactExports, j as jsxRuntimeExports, av as Primitive, aZ as createContextScope, z as cn, f as useWorkspace, g as getTenantId, h as useQuery, F as FileText, a as FolderKanban, x as Target, i as Link, B as Button, P as Plus, W as Wallet, p as Shield, c as CalendarDays, S as Sparkles, b as MessageSquare } from "./index-1XRv9GHr.js";
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card transition-smooth card-interactive h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: payrollList.length > 0 ? pl(payrollList.length, "record", "records") : "No payroll records" })
                    ] }) })
                  }
                )
              }
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card transition-smooth card-interactive h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: escrowList.length > 0 ? pl(
                        escrowList.length,
                        "total agreement",
                        "total agreements"
