import { m as useParams, f as useWorkspace, d as useNavigate, n as useQueryClient, r as reactExports, j as jsxRuntimeExports, B as Button, X, i as Link, F as FileText, C as Check } from "./index-CzyNqtbv.js";
...
import { C as CrossLinkPicker } from "./CrossLinkPicker-GY15aH5L.js";
...
import { T as Tag } from "./tag-CUWGI-eR.js";
...
import "./popover-AeYJeEj1.js";
import "./link-2-C4l0Vd2w.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "ml-auto h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors shrink-0" })
          ]
        }
      ),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3 line-clamp-2", children: tpl.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs text-muted-foreground/80 font-mono bg-muted/50 rounded-md p-2 line-clamp-2 overflow-hidden whitespace-pre-wrap break-words", children: tpl.preview })
            ]
          },
          tpl.id
        );
...
function NoteNewPage() {
  ...
  if (!pickerDone) return /* @__PURE__ */ jsxRuntimeExports.jsx(TemplatePicker, { onSelect: handleTemplateSelect });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in-up p-6 max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StickyNote, { className: "h-4 w-4 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-lg font-bold text-foreground tracking-tight", children: "New Note" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Capture your thoughts and ideas" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", noValidate: true, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border/60 bg-background p-3.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-2 border-t border-border/40", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/$workspaceId/notes", params: { workspaceId }, children: "Cancel" })
          }
        )
      ] })
    ] })
