import { s as createLucideIcon, m as useParams, n as useQueryClient, g as getTenantId, y as useInternetIdentity, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, i as Link, b as MessageSquare } from "./index-1XRv9GHr.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: `${msg.senderId.toString().slice(0, 10)}…` }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-3 top-2.5 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          EmojiPicker,
          {
...
function ThreadPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-14 items-center gap-3 border-b border-border/60 bg-card/90 backdrop-blur-sm px-4 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "ghost",
