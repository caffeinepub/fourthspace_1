import { t as createLucideIcon, m as useParams, f as useWorkspace, d as useNavigate, n as useQueryClient, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, i as Link, ac as ChevronDown, X, C as Check, b as MessageSquare } from "./index-CQ7TXF2a.js";
import { A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-DES_njqi.js";
import { I as Input } from "./input-Dkit6sfw.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-BB0XJl-b.js";
...
import { H as Hash } from "./hash-C4dlOakF.js";
      ...
      shown.map((ed) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-0.5 -right-0.5 h-2 w-2 rounded-full bg-accent border border-background" })
          ]
        },
        ed.userId.toString()
      )),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        block.type === "callout" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 top-2 text-base", children: block.calloutIcon ?? "💡" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: wrapperStyles[block.type] ?? "", children: [
          block.type === "bulletList" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-0 top-1/2 -translate-y-1/2 h-1.5 w-1.5 rounded-full bg-foreground/50" }),
          block.type === "toggle" && !block.expanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            "textarea",
            {
              ...
              placeholder: block.type === "heading1" ? "Heading 1" : block.type === "heading2" ? "Heading 2" : block.type === "heading3" ? "Heading 3" : block.type === "callout" ? "Callout note…" : block.type === "code" ? "Code…" : block.type === "quote" ? "Quote…" : block.type === "toggle" ? "Toggle title…" : "Type something, or / for blocks",
              rows: 1,
...
function NoteDetailPage() {
  ...
  reactExports.useEffect(() => {
    ...
    updatePresence();
    pollEditors();
    const presenceInterval = setInterval(updatePresence, 15e3);
    const pollInterval = setInterval(pollEditors, 8e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-8 max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
              ...
              !activeCover && /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: showCoverPicker, onOpenChange: setShowCoverPicker, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "Created",
                " ",
                new Date(Number(note.createdAt) / 1e6).toLocaleDateString(
                  "en-US",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 relative pl-6", "data-ocid": "note-block-editor", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                ...
                children: "Click to add a block, or type / to pick a type"
              }
            ) })
          ] }),
