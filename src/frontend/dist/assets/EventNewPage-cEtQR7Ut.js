import { d as useNavigate, m as useParams, n as useQueryClient, g as getTenantId, r as reactExports, E as EventCategory, a3 as RecurrenceRule, h as useQuery, j as jsxRuntimeExports, B as Button, a4 as CalendarType } from "./index-BZqaRhAX.js";
...
function EventNewPage() {
  ...
  const [calendarId, setCalendarId] = reactExports.useState("personal");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background animate-fade-in-up", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl px-6 py-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: calendarId, onValueChange: setCalendarId, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: calendars.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "personal", children: "Personal" }) : calendars.map((cal) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: cal.id, children: [
                cal.name,
                " ·",
                " ",
