import { d as useNavigate, m as useParams, n as useQueryClient, g as getTenantId, r as reactExports, a4 as RecurrenceRule, h as useQuery, E as EventCategory, j as jsxRuntimeExports, B as Button, X, F as FileText, a6 as RsvpStatus, C as Check, a7 as ExceptionType } from "./index-CzyNqtbv.js";
import { A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-fRFHS_Un.js";
...
function EventDetailPage() {
  ...
  const { mutate: respondToEvent, isPending: isResponding } = useMutation({
    ...
    onError: (err) => ue.error(err instanceof Error ? err.message : "Failed to respond")
  });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 space-y-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                onChange: (e) => {
                  ...
                  if (e.target.value && new Date(editEndTime) <= new Date(e.target.value)) {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            editEndTime && editStartTime && new Date(editEndTime) <= new Date(editStartTime) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-500", children: "End time must be after start time" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
