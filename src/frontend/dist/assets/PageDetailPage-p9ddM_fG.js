import { s as createLucideIcon, r as reactExports, f as useWorkspace, h as useQuery, j as jsxRuntimeExports, ab as ChevronDown, i as Link, B as Button, d as useNavigate, F as FileText, P as Plus, m as useParams, n as useQueryClient } from "./index-BZqaRhAX.js";
...
import { G as GripVertical } from "./grip-vertical-De961-zr.js";
  ...
  if (block.blockType === "code") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: wrapClass, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 relative rounded-lg bg-muted/80 border border-border my-0.5 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-1.5 border-b border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono", children: lang }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function PageDetailPage() {
  ...
  if (!page) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 flex flex-col items-center justify-center py-24 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/$workspaceId/pages", params: { workspaceId }, children: "Back to Pages" }) })
    ] });
  }
