import { t as createLucideIcon, m as useParams, g as getTenantId, f as useWorkspace, d as useNavigate, n as useQueryClient, an as useInternetIdentity, r as reactExports, h as useQuery, j as jsxRuntimeExports, p as Shield, B as Button, D as DollarSign, af as EscrowStatus, aQ as DisputeStatus, ai as User, aR as MilestoneStatus__1 } from "./index-CQ7TXF2a.js";
...
import { C as CircleX } from "./circle-x-BwAgpSNe.js";
...
function EscrowDetailPage() {
  ...
  const currentPrincipalText = (identity == null ? void 0 : identity.getPrincipal().toString()) ?? "";
  ...
  const isPayer = currentPrincipalText.length > 0 && contract.payerId.toString() === currentPrincipalText;
  const TABS = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in-up p-6 md:p-8 max-w-3xl mx-auto space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                ...
                isPayer && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-[10px] font-semibold text-amber-600 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/30 rounded px-1.5 py-0.5", children: "You" })
              ] })
            ] }),
    ...
    activeTab === "milestones" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: milestoneList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-dashed border-border py-12 text-center", children: [
      ...
      (() => {
        const releasedCount = milestoneList.filter(
          (m) => m.status === MilestoneStatus__1.Released
        ).length;
        const releasedAmount = milestoneList.filter((m) => m.status === MilestoneStatus__1.Released).reduce((s, m) => s + Number(m.amount), 0);
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Milestone Progress" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-foreground tabular-nums", children: [
              releasedCount,
              " / ",
      ...
      milestoneList.map((milestone) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 justify-end", children: [
            milestone.status === MilestoneStatus__1.Pending && isPayer && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
            ...
            milestone.status === MilestoneStatus__1.Pending && !isPayer && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3.5 w-3.5" }),
              "Awaiting payer"
            ] }),
    ...
    activeTab === "timeline" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      !summary && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0", children: [
      ...
      summary && summary.statusHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
