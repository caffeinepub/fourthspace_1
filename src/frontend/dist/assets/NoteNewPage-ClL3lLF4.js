import { m as useParams, f as useWorkspace, d as useNavigate, n as useQueryClient, r as reactExports, j as jsxRuntimeExports, B as Button, X, i as Link, F as FileText, C as Check } from "./index-BZqaRhAX.js";
...
`
  },
  {
    ...
    emoji: "🚢",
    name: "Release Notes",
    description: "Communicate what changed, what's fixed, and what's new in a release.",
...
`
  },
  {
    ...
    description: "Document system design, data flow, and component interactions.",
...
function NoteNewPage() {
  ...
  if (!pickerDone) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TemplatePicker, { onSelect: handleTemplateSelect });
  }
