import { s as createLucideIcon, f as useWorkspace, n as useQueryClient, g as getTenantId, r as reactExports, h as useQuery, j as jsxRuntimeExports, ak as User, ar as Moon, b0 as Bell, k as Building2, p as Shield, z as cn, A as Avatar, q as AvatarFallback, B as Button, b1 as ThemeToggle, S as Sparkles, aS as Role } from "./index-1XRv9GHr.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-CFU1s52N.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-COF0yk-T.js";
  ...
  const { mutate: saveAllSettings, isPending: isSavingAll } = useMutation({
    mutationFn: async () => {
      ...
      const result = await actor.saveUserSettings(
        ...
        notifPayroll,
        false
        // notifyGoals — not surfaced separately in UI
      );
    ...
    onError: (err) => {
      ue.error(err.message || "Failed to save settings");
    }
  });
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-5 pb-5 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-3.5 w-3.5" }),
                  workspaceSaveMutation.isPending ? "Saving…" : "Save Changes"
                ]
              }
            )
          ] })
