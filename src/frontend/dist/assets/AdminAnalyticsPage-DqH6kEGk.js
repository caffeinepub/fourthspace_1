import { b3 as clsx, R as React, b4 as getDefaultExportFromCjs, r as reactExports, d as useNavigate, f as useWorkspace, g as getTenantId, h as useQuery, F as FileText, a as FolderKanban, D as DollarSign, p as Shield, j as jsxRuntimeExports, B as Button, b as MessageSquare } from "./index-DemOGW1B.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-wtglWSxh.js";
...
import { T as TrendingUp } from "./trending-up-C7I4nXNW.js";
import { A as ArrowLeft } from "./arrow-left-lpbCbWBz.js";
import { C as ChartNoAxesColumn } from "./chart-no-axes-column-DurM4Vt_.js";
import { m as motion } from "./proxy-B22rfCLE.js";
import { f as filterProps, _ as _baseExtremum, b as _baseGt, c as _baseIteratee, d as _baseLt, i as isFunction, e as Text, p as polarToCartesian, g as Layer, h as getTickClassName, j as adaptEventsOfChild, k as Label, D as Dot, l as Curve, m as isNil, n as getValueByDataKey, S as Shape, A as Animate, o as get, q as interpolateNumber, r as isEqual, s as isNumber, t as LabelList, u as uniqueId, G as Global, v as mathSign, w as findAllByType, x as Cell, y as getMaxRadius, z as getPercentValue, E as warn, F as ErrorBar, H as hasClipDot, I as getCateCoordinateOfLine, J as generateCategoricalChart, X as XAxis, Y as YAxis, K as formatAxisMap, M as formatAxisMap$1, R as ResponsiveContainer, B as BarChart, C as CartesianGrid, T as Tooltip, a as Bar, L as Legend } from "./BarChart-DVTNsnve.js";
...
function AdminAnalyticsPage() {
  ...
  const { data: projects, isLoading: projectsLoading } = useQuery({
    ...
    queryFn: async () => actor ? actor.listProjects(tenantId, workspaceId) : [],
    enabled: !!actor && !isFetching && !!workspaceId
  });
  ...
  const { data: escrows, isLoading: escrowsLoading } = useQuery({
    ...
    queryFn: async () => actor ? actor.listEscrows(tenantId, workspaceId, null) : [],
    enabled: !!actor && !isFetching && !!workspaceId
  });
  const { data: auditLogs } = useQuery({
    queryKey: ["auditLogs", tenantId, workspaceId],
    queryFn: async () => actor ? actor.listAuditLogs(tenantId, workspaceId, BigInt(50)) : [],
    enabled: !!actor && !isFetching && !!workspaceId
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 max-w-6xl mx-auto space-y-6 animate-fade-in-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-xl bg-purple-500/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-4 w-4 text-purple-500" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold tracking-tight text-foreground", children: "Analytics" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6", children: statsData.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 10 },
        animate: { opacity: 1, y: 0 },
        transition: { delay: i * 0.06 },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border/50 bg-card shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
