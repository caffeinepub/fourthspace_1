import { g as getTenantId, f as useWorkspace, n as useQueryClient, r as reactExports, ad as OffCycleReason, h as useQuery, j as jsxRuntimeExports, B as Button, i as Link, X, P as Plus, D as DollarSign } from "./index-BZqaRhAX.js";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: payLoading || empLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 p-4", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-xl" }, n)) }) : payments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: 'Click "New Payment" to add a bonus or reimbursement.' })
              ]
            }
