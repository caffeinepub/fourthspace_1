import { s as createLucideIcon, r as reactExports, T as TaskStatus, j as jsxRuntimeExports, i as Link, au as TaskPriority, w as ChevronDown, B as Button, m as useParams, d as useNavigate, f as useWorkspace, n as useQueryClient, h as useQuery, a as FolderKanban, F as FileText, P as Plus, v as MilestoneStatus, b2 as LayoutDashboard, at as ProjectStatus, X } from "./index-1XRv9GHr.js";
...
import { R as ResponsiveContainer, B as BarChart, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, a as Bar } from "./BarChart-BLgL6krV.js";
...
import { C as CalendarRange } from "./calendar-range-Cu2Wf1L-.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-0 pointer-events-none", children: [
          ...
          task.tags && task.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 mb-1.5", children: [
            task.tags.slice(0, 3).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            task.tags.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground", children: [
              "+",
              task.tags.length - 3
            ] })
          ] }),
...
function KanbanColumn({
  ...
  const [showInlineForm, setShowInlineForm] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-[260px] sm:w-[280px] shrink-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          tasks.length === 0 && !isDragOver && !showInlineForm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center py-10 opacity-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No tasks" }) }),
          ...
          showInlineForm ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-primary/30 bg-card p-2.5 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ref: inputRef,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    isCreating && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-2.5 w-2.5 animate-spin" }),
                    "Add"
                  ]
                }
              ),
...
function ProjectDetailPage() {
  ...
  const createTaskMutation = useMutation({
    ...
    onError: (err) => ue.error(err.message || "Failed to create task")
  });
  const handleAddTask = reactExports.useCallback(
    async (title, targetStatus) => {
                    ...
                    children: COLUMNS.map((col) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-3 px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  colTasks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center py-10 opacity-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No tasks" }) }),
                                  colTasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    TaskCard,
                                    {
                                      task,
                                      projectId,
