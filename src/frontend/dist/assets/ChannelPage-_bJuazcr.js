import { s as createLucideIcon, m as useParams, n as useQueryClient, g as getTenantId, d as useNavigate, y as useInternetIdentity, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, i as Link, X, b as MessageSquare, F as FileText } from "./index-1XRv9GHr.js";
...
import { E as EmojiPicker } from "./EmojiPicker-QDr6IHYr.js";
...
import { P as Pin } from "./pin-vLvRX6kZ.js";
...
function MessageBubble({
  ...
  const senderLabel = memberDisplayName ?? `${msg.senderId.toString().slice(0, 12)}…`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        isGrouped ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 shrink-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/50 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap", children: formatRelativeTime(msg.createdAt).split(" ").slice(-1)[0] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-0.5", children: [
          !isGrouped && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: senderLabel }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-xs text-muted-foreground cursor-default",
                title: formatAbsoluteTime(msg.createdAt),
                children: formatRelativeTime(msg.createdAt)
              }
            ),
...
function ChannelPage() {
  ...
  const [olderMessages, setOlderMessages] = reactExports.useState([]);
  ...
  const markReadRef = reactExports.useRef(null);
  ...
  const scheduleMarkRead = reactExports.useCallback(() => {
  ...
  reactExports.useEffect(() => {
    const count = (recentMessages == null ? void 0 : recentMessages.length) ?? 0;
  ...
  async function handleLoadMore() {
    ...
    try {
      ...
      ue.error("Failed to load older messages");
    } finally {
      setIsLoadingMore(false);
    }
  }
  const isDM = (channel == null ? void 0 : channel.name.startsWith("dm:")) ?? false;
  let dmOtherUserId = null;
  if (isDM && (channel == null ? void 0 : channel.name)) {
    const parts = channel.name.split(":");
    const pA = parts[1];
    const pB = parts[2];
    if (pA && pB) dmOtherUserId = pA === myPrincipal ? pB : pA;
  }
  const dmOtherName = dmOtherUserId ? memberDisplayNames.get(dmOtherUserId) ?? `${dmOtherUserId.slice(0, 12)}…` : null;
  ...
  const pendingSendRef = reactExports.useRef(
    null
  );
  const sendMutation = useMutation({
    ...
    onMutate: async () => {
      var _a2, _b;
      const optimisticContent = ((_a2 = pendingSendRef.current) == null ? void 0 : _a2.content) ?? "";
      const optimisticReplyTo = (_b = pendingSendRef.current) == null ? void 0 : _b.replyToId;
      ...
      requestAnimationFrame(
        () => {
          var _a3;
          return (_a3 = bottomRef.current) == null ? void 0 : _a3.scrollIntoView({ behavior: "smooth" });
        }
      );
      return { previous };
    },
  ...
  const unreadBoundaryIndex = allMessages.length > 0 && unreadCount > 0 ? Math.max(0, allMessages.length - unreadCount) : -1;
  function handleSend() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full overflow-hidden pb-16 md:pb-0", children: [
    channel && !isDM && /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelInfoPanel, { channel }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col overflow-hidden min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto min-h-14 flex-col justify-center border-b border-border/60 bg-card/90 backdrop-blur-sm px-4 py-2 shrink-0", children: [
          ...
          isDM ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: dmOtherUserId ? senderInitials({ toString: () => dmOtherUserId }) : "DM"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-foreground text-sm truncate tracking-tight flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3.5 w-3.5 text-primary shrink-0" }),
                dmOtherName
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Direct message" })
            ] })
            ...
            !isDM && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
                size: "sm",
        ...
        !isDM && (channel == null ? void 0 : channel.topic) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-teal-600 dark:text-teal-400 italic ml-11 mt-0.5 truncate", children: [
          "📌 ",
          channel.topic
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "flex-1 py-2", "data-ocid": "messages-list", children: [
        !isLoading && allMessages.length > 0 && hasMore && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 px-4 py-4", children: [1, 2, 3, 4].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        ] }, n)) }) : allMessages.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2", children: [
          allMessages.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-teal-500/10 mb-3", children: isDM ? /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-6 w-6 text-teal-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "h-6 w-6 text-teal-500" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: isDM ? `Start a conversation with ${dmOtherName}` : `Welcome to #${channel == null ? void 0 : channel.name}!` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground max-w-xs", children: isDM ? "This is the beginning of your direct message history." : "This is the beginning of the channel. Send a message to get the conversation started." })
            ]
          }
        )
      ] }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-input bg-background focus-within:ring-1 focus-within:ring-ring p-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    ref: textareaRef,
                    placeholder: `Message ${isDM ? dmOtherName : `#${(channel == null ? void 0 : channel.name) ?? "channel"}`}…`,
                    value: messageText,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              showCharCount && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `text-[10px] font-medium ${charCount > 2e3 ? "text-destructive" : "text-amber-500"}`,
                  children: [
                    charCount,
                    "/2000"
                  ]
