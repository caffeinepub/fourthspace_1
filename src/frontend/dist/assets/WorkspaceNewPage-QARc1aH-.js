import { j as jsxRuntimeExports, z as cn, J as cva, d as useNavigate, n as useQueryClient, e as useActor, f as useWorkspace, r as reactExports, g as getTenantId, k as Building2, B as Button, S as Sparkles, P as Plus, as as setWorkspaceId, l as createActor } from "./index-1XRv9GHr.js";
...
function mapWorkspaceError(err) {
  switch (err.__kind__) {
    case "invalidName":
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      ...
                      onKeyDown: (e) => {
                        if (e.key === "Enter" && name.trim() && actorReady && !isSubmitting) {
                          void handleCreate();
                        }
                      },
