const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CJtF1vtU.js","assets/index-CzyNqtbv.js","assets/index-o5xm2drb.css"])))=>i.map(i=>d[i]);
import { s as createLucideIcon, m as useParams, an as useInternetIdentity, g as getTenantId, n as useQueryClient, d as useNavigate, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, P as Plus, aa as __vitePreload, X, i as Link, at as Variant_away_offline_online } from "./index-CzyNqtbv.js";
import { I as Input } from "./input-982h_Ebl.js";
import { L as Label } from "./label-D31XgQrg.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-AeYJeEj1.js";
  ...
  const openDMMutation = useMutation({
    mutationFn: async (targetUserId) => {
      ...
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-CJtF1vtU.js").then((n) => n.i);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in-up p-4 sm:p-6 max-w-3xl mx-auto space-y-4 sm:space-y-5 pb-20 md:pb-6", children: [
    ...
    dmMembers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dm-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-muted-foreground", children: dmMembers.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: dmMembers.map((member) => {
