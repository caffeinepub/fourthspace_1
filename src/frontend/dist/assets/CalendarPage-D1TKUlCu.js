import { d as useNavigate, m as useParams, g as getTenantId, n as useQueryClient, r as reactExports, h as useQuery, j as jsxRuntimeExports, y as cn, i as Link, B as Button, z as Settings, P as Plus, E as ChevronLeft, G as EventCategory } from "./index-DemOGW1B.js";
...
function CalendarPage() {
  ...
  const goToday_ = () => setViewDate(new Date(today.getFullYear(), today.getMonth(), 1));
  const headerLabel = () => {
  ...
  const { mutate: reschedule } = useMutation({
    ...
    onError: () => ue.error("Failed to reschedule event")
  });
