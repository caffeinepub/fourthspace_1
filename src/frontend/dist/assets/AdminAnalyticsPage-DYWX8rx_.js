import { ax as clsx, Q as o, ay as getDefaultExportFromCjs, r as reactExports, a as useNavigate, h as getTenantId, e as useQuery, m as FileText, F as FolderKanban, D as DollarSign, l as Shield, j as jsxRuntimeExports, B as Button, a3 as MessageSquare } from "./index-D7inqmxR.js";
...
import { f as filterProps, _ as _baseExtremum, c as _baseGt, d as _baseIteratee, e as _baseLt, i as isFunction, g as Text, p as polarToCartesian, L as Layer, h as getTickClassName, j as adaptEventsOfChild, k as Label, D as Dot, l as Curve, m as isNil, n as getValueByDataKey, S as Shape, A as Animate, o as get, q as interpolateNumber, r as isEqual, s as isNumber, t as LabelList, u as uniqueId, G as Global, v as mathSign, w as findAllByType, C as Cell, x as getMaxRadius, y as getPercentValue, z as warn, E as useChartWidth, F as useChartHeight, H as useOffset, I as useArbitraryXAxis, J as useYAxisWithFiniteDomainOrRandom, K as getCoordinatesOfGrid, M as getTicks, N as getTicksOfAxis, O as CartesianAxis, P as ErrorBar, Q as hasClipDot, U as getCateCoordinateOfLine, V as generateCategoricalChart, X as XAxis, Y as YAxis, W as formatAxisMap, Z as formatAxisMap$1, T as TrendingUp, R as ResponsiveContainer, B as BarChart, a as Tooltip, b as Bar, $ as Legend } from "./BarChart-DmfGE74E.js";
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$5({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$5({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$5({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$5({}, filterProps(others, true), {
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$3(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$4({
  ...
  return _createClass$2(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends$3({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends$3({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$3({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$3({
  ...
  return _createClass$1(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ o.createElement(Shape, _extends$2({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ o.createElement(Curve, _extends$2({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ o.createElement(Text, _extends$2({}, props, {
...
function AdminAnalyticsPage() {
  ...
  const { data: auditLogs } = useQuery({
    ...
    queryFn: async () => actor ? actor.listAuditLogs(tenantId, BigInt(50)) : [],
    enabled: !!actor && !isFetching
  });
  const isLoading = profilesLoading || notesLoading || projectsLoading || employeesLoading || escrowsLoading;
  const statsData = [
    {
      label: "Team Members",
    ...
    {
      label: "Total Notes",
      value: (notes == null ? void 0 : notes.length) ?? 0,
      icon: FileText,
    ...
    {
      label: "Employees",
      value: (employees == null ? void 0 : employees.length) ?? 0,
      icon: DollarSign,
    ...
    },
    {
      ...
      value: (escrows == null ? void 0 : escrows.length) ?? 0,
      icon: Shield,
    ...
    {
      label: "Audit Events",
      value: (auditLogs == null ? void 0 : auditLogs.length) ?? 0,
      icon: TrendingUp,
  ...
  const categoryDistribution = [
    { name: "Notes", value: (notes == null ? void 0 : notes.length) ?? 0 },
    { name: "Projects", value: (projects == null ? void 0 : projects.length) ?? 0 },
    { name: "Employees", value: (employees == null ? void 0 : employees.length) ?? 0 },
    { name: "Escrows", value: (escrows == null ? void 0 : escrows.length) ?? 0 },
    { name: "Users", value: (profiles == null ? void 0 : profiles.length) ?? 0 }
  ].filter((d) => d.value > 0);
  const workspaceBarData = [
    { category: "Notes", count: (notes == null ? void 0 : notes.length) ?? 142 },
    { category: "Projects", count: (projects == null ? void 0 : projects.length) ?? 23 },
    { category: "Employees", count: (employees == null ? void 0 : employees.length) ?? 18 },
    { category: "Escrows", count: (escrows == null ? void 0 : escrows.length) ?? 12 },
    { category: "Users", count: (profiles == null ? void 0 : profiles.length) ?? 24 },
    { category: "Audits", count: (auditLogs == null ? void 0 : auditLogs.length) ?? 89 }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 max-w-6xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-purple-500/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-4 w-4 text-purple-500" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Workspace usage statistics and performance metrics" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6", children: statsData.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-12 mb-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground", children: stat.value }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-sm font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-4 w-4 text-purple-500" }),
          "Workspace Overview"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 230, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: categoryDistribution.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 230, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              ...
              paddingAngle: 3,
              dataKey: "value",
              children: categoryDistribution.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Cell,
                {
        ...
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-[230px] items-center justify-center text-sm text-muted-foreground", children: "No data yet — add workspace content to see distribution." }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-sm font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "h-4 w-4 text-teal-500" }),
