import { t as createLucideIcon, r as reactExports, j as jsxRuntimeExports, as as Primitive, aX as createContextScope, y as cn, f as useWorkspace, g as getTenantId, h as useQuery, F as FileText, a as FolderKanban, al as Target, i as Link, B as Button, P as Plus, W as Wallet, p as Shield, c as CalendarDays, S as Sparkles, b as MessageSquare } from "./index-DemOGW1B.js";
...
import { A as ArrowRight } from "./arrow-right-DQHjg03f.js";
import { A as ArrowUpRight } from "./arrow-up-right-BvcB5AwX.js";
...
function StatCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-2.5 w-28" })
  ] }) });
}
function StatCardItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card hover:shadow-card-hover transition-smooth card-interactive h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground tracking-tight", children: stat.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `flex h-7 w-7 items-center justify-center rounded-lg ${stat.iconBg}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: `h-3.5 w-3.5 ${stat.iconColor}` })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground tracking-tight leading-none mb-1.5", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground tracking-tight", children: stat.sub })
      ] }) })
    }
  );
}
  ...
  const statCards = [
    {
      ...
      sub: stats && stats.noteCount > 0 ? `${stats.noteCount} note entries` : "No notes yet",
      icon: FileText,
    ...
    },
    {
      ...
      sub: stats && stats.projectCount > 0 ? `${stats.projectCount} projects` : "No active projects",
      icon: FolderKanban,
    ...
    },
    {
      ...
      sub: stats && stats.memberCount > 0 ? `${stats.memberCount} members` : "No members yet",
      icon: Users,
    ...
    },
    {
      ...
      sub: stats && stats.goalCount > 0 ? `${stats.goalCount} goals tracked` : "No goals set",
      icon: Target,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-5 md:p-6 max-w-7xl mx-auto space-y-5 sm:space-y-6 pb-20 md:pb-6", children: [
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-xl border border-primary/20 bg-gradient-to-br from-primary via-primary/80 to-purple-700/70 p-5 sm:p-7", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70 font-medium", children: stats ? `${stats.memberCount} Member${stats.memberCount !== BigInt(1) ? "s" : ""}` : "Workspace" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-semibold text-foreground tracking-tight", children: "Workspace Overview" }),
      ...
      statsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 grid-cols-2 md:grid-cols-4", children: [1, 2, 3, 4].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCardSkeleton, {}, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "grid gap-3 grid-cols-2 md:grid-cols-4",
          "data-ocid": "stats-grid",
          children: statCards.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCardItem, { stat, index: i }, stat.label))
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          className: "mt-3",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex flex-col sm:flex-row sm:items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Wallet Balance" }),
              treasuryQuery.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-32" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: icpBalance !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                icpBalance,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground ml-1.5", children: "ICP" })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-lg", children: "No wallet" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Escrow Status" }),
              escrowQuery.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-28" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold text-foreground", children: pendingEscrow > 0 ? `${pendingEscrow} pending payment${pendingEscrow !== 1 ? "s" : ""}` : "No pending payments" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: `/app/${workspaceId}/wallet/send`,
