import { m as useParams, f as useWorkspace, n as useQueryClient, r as reactExports, h as useQuery, j as jsxRuntimeExports, B as Button, i as Link, X } from "./index-CQ7TXF2a.js";
...
import { WHITEBOARD_TEMPLATES } from "./WhiteboardsListPage-DlsdcTdh.js";
import { A as ArrowLeft } from "./arrow-left-D6cz-lXM.js";
import { P as Pencil, E as Eraser, Z as ZoomIn, a as ZoomOut, U as Undo2, R as Redo2 } from "./zoom-out-DxRebBgr.js";
import { M as Minus } from "./minus-CR6DJAJb.js";
import { S as Square } from "./square-CxuF9etU.js";
import { C as Circle } from "./circle-BiZYV3sp.js";
import { T as Type } from "./type-BE9Q1nbl.js";
import { S as StickyNote } from "./sticky-note-apdBWziW.js";
import { I as Image } from "./image-C5GPlhNx.js";
import { L as Layers } from "./layers-bBrlstaN.js";
import { R as RotateCcw } from "./rotate-ccw-B_n92YJ1.js";
import { C as CircleCheck } from "./circle-check-B7zTmrRV.js";
import { S as Save } from "./save-DJl3ZDfM.js";
import "./badge-DOwzzuc_.js";
import "./input-Dkit6sfw.js";
import "./search-B58SW5UA.js";
import "./trash-2-CGgRyVAn.js";
const TOOLS = [
...
function ConvertToTaskModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm rounded-2xl border border-border bg-card shadow-xl p-6 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No projects found." })
    ] }),
...
function TemplatesPanel({ onApply, onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl rounded-2xl border border-border bg-card shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-5 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Start with a pre-built layout" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 p-5 max-h-[60vh] overflow-auto", children: WHITEBOARD_TEMPLATES.map((tpl) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(tpl.icon, { className: "h-5 w-5", style: { color: tpl.color } })
                }
              ),
...
function MobileToolbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 overflow-x-auto px-2 py-1.5 border-b border-border bg-card shrink-0 scrollbar-none", children: [
    TOOLS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-colors ${tool === t.id ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(t.icon, { className: "h-3.5 w-3.5" })
      },
      t.id
    )),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-5 w-px bg-border shrink-0 mx-0.5" }),
    tool === "Sticky" ? STICKY_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-3.5 w-3.5" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground w-8 text-center shrink-0", children: [
      Math.round(zoom * 100),
      "%"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: savedIndicator ? "Saved" : "Save" })
        ]
      }
    )
  ] });
...
function WhiteboardPage() {
  ...
  const lastTouchDist = reactExports.useRef(null);
  const lastTouchMid = reactExports.useRef(null);
  const panOffset = reactExports.useRef({ x: 0, y: 0 });
  const [panOffsetState, setPanOffsetState] = reactExports.useState({ x: 0, y: 0 });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "hidden sm:flex h-12 shrink-0 items-center justify-between gap-3 border-b border-border bg-card px-3 shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                asChild: true,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/$workspaceId/whiteboards", params: { workspaceId }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4" }) })
              }
            ),
            ...
            "div",
            {
              ...
              children: [
                ...
                tool === "Sticky" ? STICKY_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  c
                )) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: PRESET_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setColor(c),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex sm:hidden items-center gap-2 border-b border-border bg-card px-3 py-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MobileToolbar, { ...commonToolbarProps }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: containerRef,
                  ...
                  children: [
                    stickyElements.map((el) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      StickyOverlay,
                      {
                        el,
                        zoom: 1,
                        onEdit: (id, text) => setElements(
                          (prev) => prev.map(
                            (e) => e.id === id ? { ...e, stickyText: text } : e
                          )
                        ),
