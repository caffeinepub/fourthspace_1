import { s as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, f as useWorkspace, n as useQueryClient, h as useQuery, P as Plus, T as TaskStatus, au as TaskPriority, y as useInternetIdentity, b as MessageSquare, X, b5 as ActivityEventType, b6 as TaskRelationshipType, i as Link, b0 as Bell, m as useParams, d as useNavigate, a as FolderKanban, ak as User, w as ChevronDown } from "./index-1XRv9GHr.js";
...
const PRIORITY_OPTIONS = [
  ...
  },
  {
    ...
    label: "Normal",
    color: "text-blue-500",
    badge: "bg-blue-500/10 text-blue-600 border-blue-200 dark:text-blue-400 dark:border-blue-800"
  },
  {
    value: TaskPriority.High,
    label: "High",
    color: "text-orange-500",
    badge: "bg-orange-500/10 text-orange-600 border-orange-200 dark:text-orange-400 dark:border-orange-800"
  },
  {
    value: TaskPriority.Critical,
    label: "Urgent",
    color: "text-destructive",
    badge: "bg-destructive/10 text-destructive border-destructive/30 font-semibold"
  }
];
...
function TaskDetailPage() {
  ...
  const [assigneeId, setAssigneeId] = reactExports.useState("none");
  ...
  const buildInput = reactExports.useCallback(
    (overrides) => {
      var _a;
      const resolvedAssignee = assigneeId && assigneeId !== "none" ? ((_a = members.find((m) => m.userId.toString() === assigneeId)) == null ? void 0 : _a.userId) ?? void 0 : void 0;
      return {
  ...
  function triggerSave(overrides) {
    if (!isNew) {
  ...
  const updateStatusMutation = useMutation({
    ...
    onError: (err) => {
      setStatus((task == null ? void 0 : task.status) ?? TaskStatus.Todo);
      ue.error(err.message || "Failed to update status");
    }
  });
  function handleStatusChange(v) {
    ...
    if (!isNew) {
      ...
      ue.success(
        `Status set to ${((_a = STATUS_OPTIONS.find((o) => o.value === v)) == null ? void 0 : _a.label) ?? v}`
      );
    }
  }
  ...
  function handleAssigneeChange(v) {
    var _a;
    setAssigneeId(v);
    setIsDirty(true);
    if (!isNew) {
      if (saveTimerRef.current) clearTimeout(saveTimerRef.current);
      const resolvedAssignee = v !== "none" ? ((_a = members.find((m) => m.userId.toString() === v)) == null ? void 0 : _a.userId) ?? void 0 : void 0;
  ...
  const isOverdue = dueDateMs && dueDateMs < Date.now() && status !== TaskStatus.Done;
  if (isLoading && !isNew) {
  ...
  const priorityCfg = PRIORITY_OPTIONS.find((o) => o.value === priority) ?? PRIORITY_OPTIONS[1];
  const assignee = assigneeId !== "none" ? members.find((m) => m.userId.toString() === assigneeId) : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0 overflow-y-auto pb-20 md:pb-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 sm:px-6 md:px-8 pt-3 pb-3 border-b border-border/60 bg-card/80 sticky top-0 z-10 backdrop-blur-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
        saveMutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden sm:flex items-center gap-1 text-xs text-muted-foreground", children: [
        ...
        isNew && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              saveMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-3 w-3 animate-spin" }) : null,
              "Create Task"
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-5", children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs ${priorityCfg.color}`, children: priorityCfg.label }) })
                      }
                    ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: assigneeId, onValueChange: handleAssigneeChange, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
                  className: "h-10 sm:h-8 text-xs",
                  "data-ocid": "task-assignee-select",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Unassigned", children: assignee ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary/20 text-[9px] font-bold text-primary", children: (() => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Unassigned" }) }),
                members.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectItem,
                  {
                    value: m.userId.toString(),
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary/20 text-[9px] font-bold text-primary shrink-0", children: getInitials(m) }),
                      m.displayName
                    ] })
                  },
                  m.userId.toString()
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs text-muted-foreground flex items-center gap-1", children: [
              ...
              " Tags",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/60", children: "(press Enter or comma to add)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TagsInput, { tags, onChange: handleTagsChange })
          ] }),
      ...
      isNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-3 pt-4 border-t border-border/60 mt-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              saveMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : null,
              "Create Task"
            ]
          }
        )
