...
export const MOCK_GOALS: MockGoal[] = [
  {
    ...
    description:
      "Validate our enterprise offering by securing reference customers and achieving measurable retention targets across our top 10 accounts.",
    owner: "Alex Martinez",
    ownerInitials: "AM",
    ...
    keyResultList: [
      ...
      },
      {
        ...
        unit: "%",
        description:
          "Measure based on renewal rate within 30 days of contract end",
        status: "OnTrack",
      },
      {
        id: "kr1-3",
  ...
  },
  {
    ...
    description:
      "Improve customer success processes, launch proactive health monitoring, and build automated intervention flows to reduce monthly churn.",
    owner: "Sam Kim",
    ownerInitials: "SK",
  ...
  },
  {
    ...
    description:
      "Complete the mobile app redesign with improved UX, offline support, and push notifications. Launch on both iOS and Android with strong ratings.",
    owner: "Jordan Lee",
    ownerInitials: "JL",
  ...
  },
  {
    ...
    description:
      "Execute a comprehensive SEO and content strategy to triple our organic search traffic and reduce CAC from paid channels.",
    owner: "Morgan Chen",
    ownerInitials: "MC",
    contributors: ["Riley Okafor"],
    period: "Q2 2026",
    ...
    keyResultList: [
      ...
      },
      {
        id: "kr4-2",
        title:
          "Publish 20 long-form SEO articles targeting high-intent keywords",
        currentValue: 14,
        targetValue: 20,
        unit: "articles",
  ...
  },
  {
    ...
    description:
      "Improve engineering velocity, reduce incidents, and make Fourthspace engineering a destination team through strong hiring and culture initiatives.",
    owner: "Riley Okafor",
    ownerInitials: "RO",
...
export const OKR_TEMPLATES: OKRTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Improve hiring velocity, reduce turnover, and build programs that make Fourthspace a destination employer.",
    period: "Q2 2026",
    suggestedKRs: [
      {
